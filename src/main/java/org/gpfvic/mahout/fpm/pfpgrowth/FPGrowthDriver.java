...
import org.gpfvic.mahout.fpm.pfpgrowth.convertors.ContextStatusUpdater;
import org.gpfvic.mahout.fpm.pfpgrowth.convertors.SequenceFileOutputCollector;
import org.gpfvic.mahout.fpm.pfpgrowth.convertors.string.StringOutputConverter;
import org.gpfvic.mahout.fpm.pfpgrowth.convertors.string.TopKStringPatterns;
import org.gpfvic.mahout.fpm.pfpgrowth.fpgrowth.FPGrowth;
...
public final class FPGrowthDriver extends AbstractJob {
  ...
  private static void runFPGrowth(Parameters params) throws IOException {
    ...
    if ("true".equals(params.get(PFPGrowth.USE_FPG2))) {
      org.gpfvic.mahout.fpm.pfpgrowth.fpgrowth2.FPGrowthObj<String> fp
        = new org.gpfvic.mahout.fpm.pfpgrowth.fpgrowth2.FPGrowthObj<String>();
