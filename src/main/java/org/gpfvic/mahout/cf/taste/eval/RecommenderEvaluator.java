...
package org.gpfvic.mahout.cf.taste.eval;
 ...
 * {@link org.gpfvic.mahout.cf.taste.recommender.Recommender}'s recommendations.
 * </p>
 */
public interface RecommenderEvaluator {
  ...
  /**
   * <p>
   * Evaluates the quality of a {@link org.gpfvic.mahout.cf.taste.recommender.Recommender}'s recommendations.
   ...
   * This method does not accept a {@link org.gpfvic.mahout.cf.taste.recommender.Recommender} directly, but
   * rather a {@link RecommenderBuilder} which can build the
   * {@link org.gpfvic.mahout.cf.taste.recommender.Recommender} to test on top of a given {@link DataModel}.
   * </p>
   *
   * <p>
   ...
   * the {@link org.gpfvic.mahout.cf.taste.recommender.Recommender}'s predicted preferences match the user's
   ...
   *          object that can build a {@link org.gpfvic.mahout.cf.taste.recommender.Recommender} to test
   ...
   *          {@link org.gpfvic.mahout.cf.taste.recommender.Recommender} performance
   * @param evaluationPercentage
   *          percentage of users to use in evaluation
   * @return a "score" representing how well the {@link org.gpfvic.mahout.cf.taste.recommender.Recommender}'s
